...
const ing = ["sugar", "milk", "flour", "eggs"];
const time = 3;

console.log(estimatePrepTime(ing, time));
...
function calculateQuantities(ingredients, layers) {
    ...
    return { sugar: sugar ,eggs: eggs}
}

console.log(calculateQuantities(["sugar", "milk", "eggs"], 2));
console.log(calculateQuantities(["milk", "eggs"], 3));
...
function improveRecipe(ingredients, nbrOfPortions) {
    for (const i in ingredients)
    {
        ingredients[i] *= nbrOfPortions;
    }
...
console.log(improveRecipe({ eggs: 2, milk: 100, sugar: 250, flour: 160 }, 4));
