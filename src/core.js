...
function remainingBakeTime(time)
{
    return bakingTime() - time;
}
console.log(remainingBakeTime(9));
...
function calculatePreparationTime(nbrLayers) {
    return nbrLayers * 3;
}
...
function totalTimeSpent(nbrLayers, time)
{
    return calculatePreparationTime(nbrLayers) + time;
}

console.log(totalTimeSpent(3, 25));
